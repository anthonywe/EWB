		...
		<div class="row justify-content-md-center">
			<div class="col-10">
				<table class="table table-dark" style="width: 75%;">
					...
					<tbody>
						<!-- foreach.. -->
						<?php foreach($allComments as $info) { ?>
						<tr>
							...
							<td><form method="post" action="<?=base_url(); ?>admin/delete_comments"><input type="hidden" name="thisid" value="<?= $info['id']; ?>"><input class="btn btn-danger btn-md" type="submit" value="Delete"></form></td>
